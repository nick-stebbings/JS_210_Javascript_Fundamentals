...
function concat(array1, secondArgument) {
  ...
  switch (typeof secondArgument) {
    case "object":
      for (let prop in secondArgument) {
        newArr.push(secondArgument[prop]);
      }
      break;
      default:
...
// Algorithm:
//  IF the second argument is a primitive, push it onto the first
//  ELSE 
//   ITERATE through the property names of arg2, pushing the value at that property into arg1
