...
// We're undecided when it comes to modern art, and
// would rather not go in most cases.

// However, we're willing to go to any modern art museum that is about Andy Warhol (we like him!) or that is located in nearby Amsterdam.
...
function wantToVisit(museum, city) {
  return (
    ...
    (museum.includes('Art') &&
      ((museum.includes('Modern') && museum.includes('Andy Warhol')) || city == 'Amsterdam'))
  );
}
