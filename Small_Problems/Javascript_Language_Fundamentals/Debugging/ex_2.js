...
console.log(includesFalse([9422, 'lambda', true, 0, '54', null])); // true, now false.

// Answer: type coercion implicitly happening when the value 0 is encountered. Change to strict equality operator to fix.
