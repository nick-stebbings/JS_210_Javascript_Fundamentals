...
// SOLUTION:
// Array sort coerces the elements to string values before sorting. We need to use it with a callback function which returns a value of -1 when a swap needs to occur, 1 if it doesn't, 0 if the elements are the same.
